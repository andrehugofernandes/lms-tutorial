      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            ...
            {quiz.timeLimit ? `• ${quiz.timeLimit}s por questão` : ""}
          </p>
        </div>
        ...
        <Button
          className="bg-sky-700 hover:bg-sky-800 px-8"
      ...
      >
        ...
        {!result.passed && (
          <p className="text-xs text-slate-400">
            Mínimo necessário: {quiz.passingScore}%
          </p>
        )}
      </motion.div>
    );
        ...
        >
          ...
          {currentQuestion.isBonus && (
            <div className="flex items-center gap-1 text-amber-500 text-xs font-bold mb-3">
              ...
              {currentQuestion.bonusPoints && (
                <span>+{currentQuestion.bonusPoints} XP</span>
              )}
            </div>
          )}
          ...
          <div className="space-y-2">
            {currentQuestion.options.map((opt) => {
              ...
              return (
                <motion.button
                  key={opt.id}
                  whileHover={step === "playing" ? { scale: 1.01 } : {}}
