...
export async function POST(
  ...
  try {
    ...
    if (chapter.transcriptStatus === "PROCESSING") {
      return new NextResponse("A transcrição do vídeo ainda está em andamento. Tente novamente em alguns segundos.", { status: 400 });
    }
    ...
    const context = `
      ...
      ${chapter.transcript || "Nenhum conteúdo transcrito disponível para este vídeo."}
    `;
